...
public class TablePage extends BasicPage {
    ...
    public String getFirstNameColumnValue(int rowIndex) {
        return driver.findElements(By.xpath("//tbody/tr/td/td[2]"))
                .get(rowIndex).getText();
    }
    public String getLastNameColumnValue(int rowIndex) {
        return driver.findElements(By.xpath("//tbody/tr/td/td[3]"))
                .get(rowIndex).getText();
    }
    public String getMiddletNameColumnValue(int rowIndex) {
        return driver.findElements(By.xpath("//tbody/tr/td/td[4]"))
                .get(rowIndex).getText();
    }
